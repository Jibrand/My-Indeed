        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="text-center mb-20">
            ...
            <div class="flex mt-6 justify-center">
              <div class="w-16 h-1 rounded-full bg-indigo-900 inline-flex"></div>
            </div>
          </div>
          <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
            <div class="p-4 md:w-1/3 flex flex-col text-center items-center">
              <div class="w-20 h-20 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-900 mb-5 flex-shrink-0">
          ...
          <button class="flex mx-auto mt-16 text-white bg-indigo-900 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Button</button>
        </div>
      </section>
      {/* section */}
